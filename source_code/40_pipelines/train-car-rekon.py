...
def model_to_onnx(model_file: dsl.Input[dsl.Model], 
                  onnx_model_file: dsl.Output[dsl.Model]):
    import pickle
...
def iris_pipeline(model_obc: str = "iris-model"):
    ...
    validate_model(onnx_model_file=model_to_onnx_task.output)  # noqa: F841
