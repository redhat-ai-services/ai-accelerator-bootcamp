...
To create a pipeline, we will need to create a pipeline definition file. This file will contain the steps that the pipeline will execute. We will first use Elyra to create the pipeline definition file.
