...
1. Navigate to the cloned folder with the command:
[source,terminal]
----
cd ai-accelerator/
----
...
[start=2]
2. Copy `tenants/ai-example/dsp-example-pipeline` and paste it as `tenants/parasol-insurance/dsp-example`.

3. Change `line 17` of `tenants/parasol-insurance/dsp-example-pipeline/base/dsp-example-pipeline.yaml`.
...
[start=4]
4. Change `line 20` of `tenants/parasol-insurance/dsp-example-pipeline/base/dsp-example-pipeline.yaml`.
[source,yaml]
----
...
[start=5]
5. Change `line 4` of  `tenants/parasol-insurance/dsp-example-pipeline/base/kustomization.yaml`.
```
 namespace: parasol-insurance
```

[start=6]
6. Copy `tenants/ai-example/datascience-pipelines` and paste it as `tenants/parasol-insurance/datascience-pipelines`.

[start=7]
7. Change `line 33` of `tenants/parasol-insurance/datascience-pipelines/base/dspa.yaml`

```
host: 'minio.parasol-insurance.svc.cluster.local:9000'
```
[start=8]
8. Change `line 4` of `tenants/parasol-insurance/datascience-pipelines/base/kustomization.yaml`.
