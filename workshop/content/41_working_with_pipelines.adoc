...
. Modfify `tenants/ai-example/dsp-example-pipeline` and paste it as `tenants/parasol-insurance/dsp-example`.

. Create directories `tenants/parasol-insurance/dsp-example/{base,overlay}`.

. Modify the following file `tenants/parasol-insurance/dsp-example-pipeline/base/dsp-example-pipeline.yaml`.
...
. Modify file `tenants/parasol-insurance/dsp-example-pipeline/base/execute-kfp-task.yaml`
...
. Modify file `tenants/parasol-insurance/dsp-example-pipeline/base/kustomization.yaml`
