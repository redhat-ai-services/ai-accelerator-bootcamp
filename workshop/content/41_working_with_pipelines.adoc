...
## CONTINUE INSTRUCTIONS FOR THE NEXT SECTIONS FOLLOWING THIS BY STEP PATTERN
...
. Create file `tenants/parasol-insurance/dsp-example-pipeline/base/dsp-example-imagestream.yaml`.
...
. Create file `tenants/parasol-insurance/dsp-example-pipeline/base/dsp-example-pipelinerun.yaml`.
...
. Create file `tenants/parasol-insurance/dsp-example-pipeline/base/dsp-example-pipeline.yaml`.
...
. Create file `tenants/parasol-insurance/dsp-example-pipeline/base/dsp-example-rbac.yaml`.
