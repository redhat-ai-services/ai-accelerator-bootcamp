...
* your env is provisioned log into the ROSA console to generate your login command or connect to your bastion host. 

image::images/awsrosaclipping.png[ROSA credentials]
