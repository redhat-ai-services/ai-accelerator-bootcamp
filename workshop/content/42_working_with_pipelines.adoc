...
<<<<<<< HEAD:workshop/content/42_working_with_pipelines.adoc
=======
...
>>>>>>> 23bd4da ( adding tip for model_retrain_pipeline, Last step failed and may need work):workshop/content/41_working_with_pipelines.adoc
