...
[CAUTION]
====
You have not entered the CHALLENGE PHASE of your project! You are now enabled! Your team lead has died! You must Deploy the model to prod using ideally fully using gitops. 
